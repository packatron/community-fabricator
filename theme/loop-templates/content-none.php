...
<section class="no-results not-found mt-5">
	...
	<div class="page-content">
		<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			<p>
				<?php
				printf( wp_kses( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'understrap' ), array(
				'a' => array(
				'href' => array(),
				),
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php esc_html_e( 'Looking for people or posts? Try entering a name, location, or different words.', 'understrap' ); ?></p>
		<?php else : ?>
