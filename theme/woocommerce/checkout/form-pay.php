	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'community-fabricator' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'community-fabricator' ); ?></th>
			</tr>
		</thead>
		<tbody>
